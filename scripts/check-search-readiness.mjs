...
export async function auditSite(origin = publicOrigin) {
  ...
  const pages = [...urls.map(url => [url, url]), ...['index.html'].map(page => [`${publicOrigin}/${page}`, `${publicOrigin}/daycare-map.html`])]; // SOFTM-DAYCARE-LANDING 날짜:20260904 : 두 지도와 주야간보호 안내의 검색 대표 연결을 같이 검사
