...
(function(root){
 ...
 function mount(options){
  ...
  dialog.innerHTML='<button type="button" class="care-sort-close" aria-label="정렬 닫기">×</button><h2 id="careSortTitle">정렬 옵션</h2><fieldset><legend>중심점</legend><label><input type="radio" name="careSortOrigin" value="map">지도중심</label><label><input type="radio" name="careSortOrigin" value="current">내위치중심</label></fieldset><fieldset class="care-sort-modes"><legend>정렬 기준</legend></fieldset><p class="care-sort-help">정확도순은 기관명·주소의 검색어 일치도를 우선합니다. 같은 정확도는 가까운 순으로, 위치 미확인 기관은 뒤에 표시합니다.</p><p role="status" class="care-sort-status"></p><button type="button" class="care-sort-apply">적용</button>';
