...
(function (root) {
    ...
    function init(config) {
        ...
        if (options.match) {
            const connect = (attempt = 0) => import(`./care-match.js?v=20260911-match-clear1&attempt=${attempt}`).then(module => { // SOFTM-MATCH-CLEAR 날짜:20260911 : 맞춤 조건 지우기 동작을 이전 캐시 없이 적용
