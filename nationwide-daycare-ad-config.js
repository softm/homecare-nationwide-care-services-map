 ...
 *
 * mode
 * - hybrid: 상단·첫 목록 카카오 AdFit + 두 번째 이후 목록 제휴 문의 // SOFTM-LIST-AD-RESTORE 날짜:20260904 : 운영 설명과 실제 슬롯 순서를 일치
 * - kakao: 카카오 AdFit 상단·첫 목록 광고 // SOFTM-LIST-AD-RESTORE 날짜:20260904 : 카카오 전용 모드에도 목록 광고를 유지
 * - direct: 직접광고만
 * - off: 광고 전체 중지
 *
...
window.DAYCARE_AD_CONFIG = {
  ...
  placements: {
    banner: true,
    listNative: true,
    /** SOFTM-LIST-AD-REPEAT START 날짜:20260904 : 첫 카카오 광고 다음부터 6개 간격으로 문의를 표시 */
    listAfter: 6,
    listRepeat: 6
    /** SOFTM-LIST-AD-REPEAT END */
  },
  kakao: {
